...
public class DirectionActivity extends FragmentActivity implements GoogleMap.OnMyLocationChangeListener {
        ...
        if (b != null) {
            ...
            nama = b.getString(com.example.iazis.museum.map.KEY_NAMA);
                ...
                // Checks, whether start and end locations are captured
                    ...
                    LatLng origin = new LatLng( start.latitude, start.longitude );
                    LatLng dest = new LatLng(end.latitude,	end.longitude );
    ...
    private String downloadUrl(String strUrl) throws IOException{
        ...
        try{
            ...
            Log.d("Exceptiong url", e.toString());
        }finally{
            iStream.close();
